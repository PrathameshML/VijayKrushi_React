...
export const products = [
  {
    ...
    resources: [
      { title: "Spare Parts Catalog (Back Rotor)", title_mr: "स्पेअर पार्ट्स कॅटलॉग (बॅक रोटर)", url: "/resources/vka_178br_back_rotor_spares.pdf" },
      { title: "Power Weeder Attachments", title_mr: "पॉवर वीडर अटॅचमेंट्स", url: "/resources/power_weeder_attachments.pdf" }
    ]
  },
  {
  ...
  },
  {
    ...
    specs: { "Transmission": "Belt Type", "Engine Model": "170F", "Fuel": "Petrol" },
    resources: [
      { title: "Engine & Belt Drive Spares", title_mr: "इंजिन आणि बेल्ट ड्राइव्ह स्पेअर पार्ट्स", url: "/resources/vka_170fg_belt_drive_spares.pdf" },
      { title: "Chain Drive Spares", title_mr: "चेन ड्राइव्ह स्पेअर पार्ट्स", url: "/resources/vka_170fg_chain_drive_spares.pdf" },
      { title: "Power Weeder Attachments", title_mr: "पॉवर वीडर अटॅचमेंट्स", url: "/resources/power_weeder_attachments.pdf" }
    ]
  },
  {
    ...
    specs: { "Transmission": "Gear Type", "Engine Model": "170G", "Fuel": "Petrol" },
    resources: [
      { title: "Gear Box Spares", title_mr: "गिअर बॉक्स स्पेअर पार्ट्स", url: "/resources/vka_170g_gear_box_spares.pdf" },
      { title: "Engine Gear Driven Spares", title_mr: "इंजिन गिअर ड्रिव्हन स्पेअर पार्ट्स", url: "/resources/vka_170g_engine_spares.pdf" },
      { title: "Power Weeder Attachments", title_mr: "पॉवर वीडर अटॅचमेंट्स", url: "/resources/power_weeder_attachments.pdf" }
    ]
  },
  {
    ...
    specs: { "Type": "Gasoline Rotary", "Model": "44F" }
  },
  {
    ...
    specs: { "Type": "Gasoline Rotary", "Model": "50F" }
  },
  {
    ...
    specs: { "Model": "PW-12DE", "Fuel": "Diesel" }
  },
  {
  ...
  },
  {
    ...
    specs: { "Model": "173FA", "Type": "HTP Power Sprayer" }
  },
  {
    ...
    specs: { "Model": "186FB", "Type": "HTP Power Sprayer" }
  },
  {
    ...
    specs: { "Type": "Manual Garden Sprayer", "Variants": "Multiple sizes available" }
  },
  {
    ...
    specs: { "Type": "Hand Push Seeder", "Brand": "Airavat" }
  },
  {
    ...
    specs: { "Type": "Hand Push Seeder", "Brand": "Chetak" }
  },
  {
    ...
    specs: { "Type": "Hand Push Seeder", "Brand": "Gajaraj" }
  },
  {
    ...
    specs: { "Type": "Hand Push Seeder", "Brand": "Rainbow" }
  },
  {
    ...
    specs: { "Type": "Hand Push Seeder", "Brand": "Runner" }
  },
  {
    ...
    specs: { "Type": "Hand Push Seeder", "Brand": "Varad" }
  },
  {
    ...
    specs: { "Type": "Hand Push Seeder", "Brand": "Varun" }
  },
  {
    ...
    specs: { "Type": "Hand Push Seeder", "Brand": "Vijay" }
  },
  {
    ...
    specs: { "Type": "Hand Push Seeder", "Model": "017A" }
  },
  {
    ...
    specs: { "Type": "Hand Push Seeder", "Brand": "Growth" }
  },
  {
    ...
    specs: { "Type": "Garden Tools Set", "Includes": "Multiple garden tools" }
  },
  {
  ...
  },
  {
    ...
    specs: { "Type": "Garden Secateur/Pruner" }
  },
  {
    name: "Hand Gloves",
    name_mr: "हँड ग्लव्हज",
  ...
  },
  {
    ...
    specs: { "Type": "Irrigation Sprinkler" }
  },
  {
    ...
    specs: { "Type": "Various Agricultural Equipment" }
  }
